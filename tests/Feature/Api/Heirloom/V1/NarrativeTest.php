...
class NarrativeTest extends TestCase
{
    ...
    private function createUserWithTranscript(): array
    {
        ...
        return [$user, $session, $transcript];
    }
    ...
    public function test_user_can_synthesise_a_narrative(): void
    {
        ...
        [$user, $session, $transcript] = $this->createUserWithTranscript();

        $response = $this->actingAs($user)
            ->postJson("/api/heirloom/v1/transcripts/{$transcript->id}/narratives", [
                'format' => 'memoir',
            ]);
    ...
    public function test_user_cannot_synthesise_another_users_transcript(): void
    {
        [$owner, $session, $transcript] = $this->createUserWithTranscript();
